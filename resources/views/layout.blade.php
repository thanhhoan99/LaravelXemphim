...
<html lang="vi">
   ...
   <body class="home blog halimthemes halimmovies" data-masonry="">
                        ...
                        {{-- <style type="text/css">
                           ...
                           <div class="form-group form-timkiem">
                              <div class="input-group col-xs-12">
                                 ...
                                 <button class="btn btn-primary" style="float: right; position:absolute" >Tìm Kiếm</button>
                              </form>
                              </div>
                           </div>

                        <ul class="list-group" id="result" style="display: none ; position: absolute;
                        z-index: 9999;
                        background:#1b2d3c;
         ...
         <div class="container footer-columns">
            <div class="row container">
               <div class="widget about col-xs-12 col-sm-4 col-md-4">
                  ...
                  <img src="{{asset('uploads/logo/'.$info->logo)}}" height="95">
                  </div>
      ...
      <div id="fb-root"></div>
      <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v15.0" nonce="TwZGZpnr"></script>
      <div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v15.0" nonce="uiKwarv9"></script>
            ...
            $(document).ready(function(){
               $('#timkiem').keyup(function(){
                  ...
                  if(search !=''){
                     ...
                     $.getJSON('/webphim/public/json/movies.json',function(data){
                        $.each(data,function(key,value){
                           if(value.title.search(expression)!=-1 || value.description.search(expression)!=-1){
                              $('#result').append('<li style="cursor:pointer" class="list-group-item link-class"><img src="/webphim/public/uploads/movie/'+value.image+'" height="40px" width="40px">'+value.title+' <br/> | <span>'+value.description+'</span></li>');
                           }
                        });
                     })
                  }else{
...
<div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v15.0" nonce="VhIxJ0Mc"></script>
