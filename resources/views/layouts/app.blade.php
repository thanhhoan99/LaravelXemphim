...
SmartPhone Compatible web template, free WebDesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design"
                  ...
                  <ul class="treeview-menu ">
                    <li>
                      <a href="{{route('category.create')}}"
                        ><i class="fa fa-angle-right"></i> Thêm</a
                      >
                    </li>
                    <li>
  ...
  <script type="text/javascript">
      $('.cate_chosse').change(function() {
          ...
          $.ajax({
              ...
              success: function(data) {
               alert ('Thay đỏi thành công');
              }
          });
      })
    </script>
     <script type="text/javascript">
      $('.resolution_chosse').change(function() {
          var resolu_val = $(this).val();
          var movie_id = $(this).attr('id');
          // alert (movie_id);
          // alert (cate_id);

          $.ajax({
              url: "{{ route('resolution-chosse') }}",
              method: "GET",
              data: {
                  resolu_val: resolu_val,
                  movie_id:movie_id
              },
              success: function(data) {
               alert ('Thay đỏi thành công');
     ...
     <script type="text/javascript">
      $('.country_chosse').change(function() {
